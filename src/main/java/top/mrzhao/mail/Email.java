 ...
 */
public class Email {
    private static String defaultSenderName = "2402076197@qq.com";// 默认的发件人用户名，defaultEntity用得到
    private static String defaultSenderPass = "acpnnfsqbdwpdhgd";// 默认的发件人密码，defaultEntity用得到
    private static String defaultSmtpHost = "stmp.qq.com";// 默认的邮件服务器地址，defaultEntity用得到
    ...
    private void init() {
        ...
        props.put("top.mrzhao.mail.smtp.host", smtpHost);
        props.put("top.mrzhao.mail.smtp.auth", "true"); // 需要身份验证
        //端口号，QQ邮箱给出了两个端口，但是另一个我一直使用不了，所以就给出这一个587
        props.put("top.mrzhao.mail.smtp.port", "587");
        // 此处填写你的账号
        props.put("top.mrzhao.mail.user", sendUserName);
        // 此处的密码就是前面说的16位STMP口令
        props.put("top.mrzhao.mail.password", sendUserPass);
    ...
    public boolean send() throws Exception {
        ...
        // 连接邮件服务器并进行身份验证
        transport.connect(smtpHost, sendUserName, "acpnnfsqbdwpdhgd");
        // 发送邮件
